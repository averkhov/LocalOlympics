...
<html>
  ...
  <%
	...
	%>
		...
		<div class="top" id="menudrop" style="float:right"><a href="#" class="topbarmenu" onmouseover="popup();" onmouseout="popoff();"><%=username%></a></div>
		...
		<ul>
			...
			<li><a class="topbarmenu" href="/logout">LOGOUT</a></li>
                        ...
                        <li><a class="topbarmenu" href="/login.jsp" >LOGIN</a></li>
